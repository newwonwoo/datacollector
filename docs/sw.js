...
const CACHE = 'collector-shell-v2';
...
self.addEventListener('fetch', (e) => {
  ...
  // Never cache API or live data. dashboard.html is regenerated by
  // `collector app` on each start, so a cache-first hit would serve a stale
  // report after new runs — route it to the network too.
